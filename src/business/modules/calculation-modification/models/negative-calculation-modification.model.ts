...
export default class NegativeCalculationModificationModel extends CalculationModification {

  public static create(paymentUid: string, usersUid: string[], mathExpression: number, comment?: string): NegativeCalculationModificationModel {
